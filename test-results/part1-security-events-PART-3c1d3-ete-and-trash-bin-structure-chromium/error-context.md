...
- Name: part1-security-events.spec.ts >> PART 1 — Security, Dashboard Soft Delete & Event Type Architecture >> Dashboard page loads correctly and supports soft delete and trash bin structure
- Location: tests\part1-security-events.spec.ts:65:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/giris-yap
Call log:
  - navigating to "http://localhost:3000/giris-yap", waiting until "load"

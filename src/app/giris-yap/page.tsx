    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-6">
      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 border border-slate-100">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slate-800 mb-2">Hoş Geldin</h1>
          <p className="text-slate-500 text-sm">Davetiyeni yönetmek için giriş yap.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full py-4 bg-rose-500 text-white rounded-xl font-bold hover:bg-rose-600 transition-colors disabled:opacity-50 mt-4"
          >
        ...
        <div className="mt-8 text-center text-sm text-slate-500">
          Henüz hesabın yok mu? <Link href="/kayit-ol" className="text-slate-800 font-bold hover:underline">Ücretsiz Kayıt Ol</Link>
        </div>
      </div>
    </div>
  );

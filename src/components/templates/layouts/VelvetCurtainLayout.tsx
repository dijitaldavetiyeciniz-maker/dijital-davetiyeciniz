...
export default function VelvetCurtainLayout({ wedding, primaryColor, textColor, headingFont, dateStr, renderRsvpButton, renderGuestBook }: any) {
  return (
    <div className="w-full max-w-md mx-auto bg-[#4a0e1c] text-[#e8d5b5] shadow-2xl overflow-hidden rounded-t-[10rem] border-4" style={{ borderColor: primaryColor }}>

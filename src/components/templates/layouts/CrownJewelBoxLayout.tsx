...
export default function CrownJewelBoxLayout({ wedding, primaryColor, textColor, headingFont, dateStr, renderRsvpButton, renderGuestBook }: any) {
  return (
    <div className="w-full max-w-sm mx-auto bg-white shadow-[0_20px_50px_rgba(236,72,153,0.2)] p-1 border-[16px] border-[#FCE7F3]">
      <div className="border border-pink-200 p-8 text-center bg-pink-50/50">

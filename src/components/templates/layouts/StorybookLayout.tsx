...
export default function StorybookLayout({ wedding, primaryColor, textColor, headingFont, dateStr, renderRsvpButton, renderGuestBook }: any) {
  return (
    <div className="w-full max-w-2xl mx-auto bg-[#FDF8F5] shadow-2xl flex flex-col md:flex-row text-slate-800 rounded-xl overflow-hidden border border-slate-200">

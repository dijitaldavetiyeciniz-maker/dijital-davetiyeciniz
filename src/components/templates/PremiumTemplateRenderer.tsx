    ...
    >
      ...
      {isMapModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in font-sans">
          <div 
            className={`w-full max-w-sm rounded-3xl p-6 relative border shadow-2xl transition-all scale-up ${
              textIsLight ? 'bg-slate-900 border-slate-800 text-white' : 'bg-white border-slate-100 text-slate-800'
            }`}
          >
            <button 
              type="button"
            ...
            <h3 className="font-serif font-bold text-lg mb-2 text-center">🗺️ Yol Tarifi Al</h3>

...
- **Tier 1 (Locked) Planned Unique:** 93
- **Tier 2 (Stretch) Planned Unique:** 39
- **Total Planned Unique Designs:** 132
- **Projected Total Unique Designs:** 180
- **Tier 3 (Rejected/Merged) Ideas:** 10
...
| `planetarium-romance` | Modern | Celestial / Fantasy | `Observatory` | `spotlight` | scroll-lens-focus-names | **10/10** |
| `enchanted-forest` | Doğal | Fairy Tale | `Pop-up Book` | `gardenGate` | scroll-bloom-flowers-vines | **10/10** |
| `crystal-castle` | Lüks | Fairy Tale | `Pop-up Book` | `royalPalace` | scroll-shatter-reveal-details | **10/10** |
| `secret-fairy-garden` | Doğal | Fairy Tale | `Pop-up Book` | `gardenGate` | scroll-fairy-dust-draw-path | **6/10** |
| `storybook-kingdom` | Klasik | Fairy Tale | `Story Chapters` | `book` | scroll-open-storybook-pages | **10/10** |
| `midnight-carriage` | Karanlık | Fairy Tale | `Cinematic Scroll` | `curtain` | scroll-carriage-moves | **10/10** |
| `floating-lantern-kingdom` | Doğal | Fairy Tale | `Cinematic Scroll` | `starryNight` | scroll-lanterns-float-up | **10/10** |
| `enchanted-library` | Klasik | Fairy Tale | `Story Chapters` | `book` | scroll-bookshelf-reveal-chapters | **10/10** |
...
| `atlantis-ceremony` | Karanlık | Mythological | `Underwater Journey` | `nazarDome` | scroll-dive-atlantis-ruins | **6/10** |
...
| `paper-moon` | Doğal | Surreal / Artistic | `Paper Cut Diorama` | `book` | scroll-shadowbox-depth-shift | **10/10** |
...
| `japanese-zen-garden` | Kültürel | Cultural | `Japanese Shoji Page` | `book` | scroll-slide-shoji-panels | **10/10** |
| `turkish-tile-garden` | Kültürel | Cultural | `Anatolian Grid` | `nazarDome` | scroll-glazed-tile-reveal-sparkle | **6/10** |
| `cappadocia-sunset-balloon` | Kültürel | Cultural | `Vertical Balloon Journey` | `coastalSunset` | scroll-balloons-rise-up | **10/10** |
| `bosphorus-mansion` | Kültürel | Cultural | `Cinematic Scroll` | `coastalSunset` | scroll-bridge-ferry-drift | **10/10** |
| `moroccan-riad-henna-night` | Kültürel | Cultural | `Moroccan Riad Layout` | `door` | scroll-open-riad-doors-henna | **5/10** |
| `japanese-folding-screen-sakura` | Kültürel | Cultural | `Japanese Folding Screen` | `book` | scroll-unfold-gold-screen | **10/10** |
...
| `tuscany-vineyard-manor` | Doğal | Destination | `Vineyard Story Chapters` | `gardenGate` | scroll-vineyard-depth-parallax | **10/10** |
| `provence-lavender-estate` | Doğal | Destination | `Vineyard Story Chapters` | `gardenGate` | scroll-lavender-petals-scatter | **6/10** |
| `cotswolds-garden-estate` | Doğal | Destination | `Vineyard Story Chapters` | `gardenGate` | scroll-climbing-roses-grow | **5/10** |
| `swiss-alps-chalet` | Doğal | Destination | `Mountain Elevation Journey` | `gardenGate` | scroll-chalet-snow-depth | **10/10** |
...
| `cote-d-azur-yacht-club` | Lüks | Destination | `Luxury Hotel Editorial` | `coastalSunset` | scroll-yacht-drifts-across-sea | **5/10** |
| `cappadocia-valley-baloons` | Doğal | Destination | `Vertical Balloon Journey` | `coastalSunset` | scroll-balloons-rise-up-valley | **4/10** |
| `istanbul-ferry-bosphorus` | Kültürel | Destination | `Cinematic Scroll` | `coastalSunset` | scroll-maiden-tower-ferry-drift | **4/10** |
| `bali-temple-garden` | Doğal | Destination | `Vineyard Story Chapters` | `gardenGate` | scroll-temple-gates-part | **6/10** |
| `safari-adventure-jungle` | Çocuk | Children | `Kids Adventure Map` | `cloudBalloon` | scroll-safari-jeep-drive-track | **9/10** |
| `underwater-kingdom-marine` | Çocuk | Children | `Underwater Journey` | `cloudBalloon` | scroll-dive-submarine-ocean | **9/10** |
| `dinosaur-expedition-park` | Çocuk | Children | `Kids Adventure Map` | `cloudBalloon` | scroll-hatch-dino-egg | **5/10** |
| `space-explorer-orbit` | Çocuk | Children | `Space Mission` | `starryNight` | scroll-rocket-launch-orbit | **9/10** |
| `woodland-fairy-wonderland` | Çocuk | Children | `Story Chapters` | `storybook` | scroll-grow-fairy-mushrooms | **8/10** |
| `candy-kingdom-sweet` | Çocuk | Children | `Kids Adventure Map` | `cloudBalloon` | scroll-roll-gumball-machine | **5/10** |
| `circus-carnival-tent` | Çocuk | Children | `Theatre Program` | `curtain` | scroll-carousel-horses-rotate | **10/10** |
| `pirate-treasure-island` | Çocuk | Children | `Kids Adventure Map` | `book` | scroll-track-ship-treasure-x | **7/10** |
| `princess-garden-castle` | Çocuk | Children | `Story Chapters` | `storybook` | scroll-reveal-princess-castle | **4/10** |
...
| `circumcision-astronaut-boy` | Sünnet | Circumcision | `Space Mission` | `starryNight` | scroll-rocket-launch-orbit | **7/10** |
...
| `bohemian-henna-night` | Kına Gecesi | Engagement / Henna | `Vineyard Story Chapters` | `gardenGate` | scroll-pampas-sway-breeze | **10/10** |
| `moroccan-riad-henna-pavilion` | Kına Gecesi | Engagement / Henna | `Moroccan Riad Layout` | `door` | scroll-open-riad-double-gates | **4/10** |
...
| `luxury-perfume-launch-style` | Lüks | Luxury Premium | `Fashion Editorial` | `vogueEditorial` | scroll-silk-sheets-ripple | **5/10** |
...
| `starlight-canyon` | Doğal | Celestial / Fantasy | `Cinematic Scroll` | `coastalSunset` | scroll-canyon-depth | **5/10** |
| `rose-castle` | Doğal | Fairy Tale | `Pop-up Book` | `envelope` | scroll-unroll-rose-briar | **7/10** |
| `magic-mirror-ball` | Lüks | Fairy Tale | `Cinematic Scroll` | `mirror` | scroll-mirror-shimmer-clear | **10/10** |
| `whispering-forest` | Doğal | Fairy Tale | `Pop-up Book` | `gardenGate` | scroll-leaves-blow-across | **6/10** |
...
| `origami-world` | Minimalist | Surreal / Artistic | `Paper Cut Diorama` | `book` | scroll-origami-crane-flaps | **9/10** |
| `glass-garden` | Modern | Surreal / Artistic | `Vertical Spatial Journey` | `glassReveal` | scroll-clear-foggy-glass | **7/10** |
| `persian-miniature-concept` | Kültürel | Cultural | `Persian Manuscript` | `ottomanIllumination` | scroll-unroll-miniature-panels | **5/10** |
| `korean-hanok-traditional` | Kültürel | Cultural | `Japanese Shoji Page` | `book` | scroll-slide-hanji-windows | **5/10** |
| `andalusian-palace-alhambra` | Kültürel | Cultural | `Moroccan Riad Layout` | `door` | scroll-open-myrtle-gates | **5/10** |
| `mughal-garden-taj` | Kültürel | Cultural | `Persian Manuscript` | `ottomanIllumination` | scroll-reflect-pool-water | **5/10** |
| `scandinavian-forest-nordic` | Doğal | Cultural | `Minimalist Grid` | `minimalFade` | scroll-minimal-line-drawing | **10/10** |
| `alpine-lodge-woodlands` | Doğal | Cultural | `Cinematic Scroll` | `gardenGate` | scroll-snowflakes-drift-down | **10/10** |
| `maldives-overwater-sunset` | Doğal | Destination | `Santorini Blue Split` | `coastalSunset` | scroll-beach-sand-reveal | **5/10** |
| `kyoto-sakura-shrine` | Kültürel | Destination | `Japanese Folding Screen` | `book` | scroll-unfold-shrine-screen | **5/10** |
| `toy-train-railway` | Çocuk | Children | `Horizontal Journey` | `cloudBalloon` | scroll-train-moves-along-track | **10/10** |
| `farm-adventure-animals` | Çocuk | Children | `Kids Adventure Map` | `cloudBalloon` | scroll-tractor-drives-pastures | **5/10** |
| `robot-laboratory-science` | Çocuk | Children | `Holographic Interface` | `minimalFade` | scroll-gears-rotate-assemble | **7/10** |
| `ocean-explorer-submarine` | Çocuk | Children | `Underwater Journey` | `cloudBalloon` | scroll-sea-diver-submerge | **5/10** |
| `arctic-animals-snowy` | Çocuk | Children | `Mountain Elevation Journey` | `cloudBalloon` | scroll-polarbears-slide-ice | **6/10** |
...
| `circumcision-adventure-map` | Sünnet | Circumcision | `Kids Adventure Map` | `book` | scroll-trail-draws-x | **9/10** |
...
| `regal-dynasty-lux` | Lüks | Luxury Premium | `Royal Decree` | `royalPalace` | scroll-unroll-purple-scroll | **4/10** |
| `vanderbilt-estate-lux` | Lüks | Luxury Premium | `Royal Decree` | `gardenGate` | scroll-estate-gates-part | **7/10** |
| `experimental-analog-television` | Karanlık | Experimental | `Obsidian Soundboard` | `spotlight` | scroll-television-dials-turn | **7/10** |
| `experimental-architects-blueprint` | Minimalist | Experimental | `Architectural Blueprint` | `minimalFade` | scroll-blueprint-dimensions | **4/10** |
| `experimental-secret-agent` | Karanlık | Experimental | `Obsidian Soundboard` | `book` | scroll-unseal-classified-doc | **10/10** |
...
- **Content Flow:** vertical-spatial
- **Opening Animation:** spotlight (`spotlight` family)
...
- **Visual Language:** terracotta-warm-indigo
- **Typography:** Cinzel + Cormorant Garamond
- **Background Type:** night-canyon-milkyway
- **Photo Treatment:** cinematic-crop
- **Decorative Language:** organic-rock-shapes
- **Content Flow:** vertical-parallax
- **Opening Animation:** coastalSunset (`coastalSunset` family)
- **Motion Language:** parallax-rise
- **Signature Moment:** scroll-canyon-depth
- **Difference Score:** 5/10 (Compared to `coastal-sunset`)
- **Key Differences:** hero, background, photoTreatment, decorativeLanguage, motionLanguage
...
- **Opening Animation:** gardenGate (`gardenGate` family)
...
- **Content Flow:** vertical-spatial
- **Opening Animation:** royalPalace (`royalPalace` family)
...
- **Difference Score:** 6/10 (Compared to `enchanted-forest`)
- **Key Differences:** hero, visualLanguage, background, photoTreatment, decorativeLanguage, motionLanguage
...
- **Content Flow:** vertical-unfold
- **Opening Animation:** book (`book` family)

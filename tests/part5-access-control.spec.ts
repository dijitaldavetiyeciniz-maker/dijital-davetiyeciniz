...
test.describe('PART 5A - Access Control E2E', () => {
  ...
  test('Access Control API Flow', async ({ request }) => {
    ...
    const anonRes = await request.get('/api/guests?wedding_id=a0000000-0000-0000-0000-000000000001');
    ...
    // with 401 or 403.
    const getRes = await request.get('/api/guests?wedding_id=a0000000-0000-0000-0000-000000000001');
